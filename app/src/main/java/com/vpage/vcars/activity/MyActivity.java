...
public class MyActivity extends AppCompatActivity implements
    ...
    @UiThread
    public void callRoutePath(){
        if (LogFlag.bLogOn) Log.d(TAG, "callRoutePath");

        LatLng sourceLocation = new LatLng(latLng.latitude,latLng.longitude);
        LatLng currentLocation = new LatLng(13.0537931,80.2352246);
        callRouteTrack(sourceLocation,currentLocation);

    }


    @Background
    public void callRouteTrack(LatLng sourceLocation,LatLng currentLocation){

        RoutDetector routDetector = new RoutDetector(MyActivity.this,sourceLocation,currentLocation);
    ...
    public void callRouteTrackFinish(){
        ...
        mGoogleMap.addPolyline(polyLines);
    }
