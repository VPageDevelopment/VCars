package com.vpage.vcars.tools.fab;
...
public class FloatingActionButton extends ImageButton {
  ...
  void init(Context context, AttributeSet attributeSet) {
    ...
    mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal, getColor(R.color.colorAccent));
    mColorPressed = attr.getColor(R.styleable.FloatingActionButton_fab_colorPressed, getColor(R.color.White));
  ...
  */
  ...
  public void setTitle(String title) {
    ...
    if (label != null) {
      label.setText(title);
      label.setTextSize(Float.parseFloat(getResources().getString(R.string.fab_text_size)));
